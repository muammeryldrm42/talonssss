...
export default definePlugin({
  name: "@open-talons/plugin-solana",
  version: "1.0.0",
  ...
  agents: [
    defineAgent({
      mode: "solana",
      icon: "☀️",
      name: "Solana Ecosystem Agent",
      systemPrompt: `☀️ Open Talons Solana Ecosystem Agent.
- jupiter_price + solana_token_info for tokens
- birdeye_trending for hot tokens
- raydium_pools + orca_whirlpools for LP
- solana_lst_rates for liquid staking
- drift_markets for perp DEX, kamino_rates for lending
- solana_network_stats + solana_priority_fees for network health
- helius_assets_by_owner for wallet analysis`,
      allowedTools: ["jupiter_price", "solana_token_info", "birdeye_trending", "raydium_pools", "orca_whirlpools", "solana_lst_rates", "solana_network_stats", "solana_priority_fees", "drift_markets", "kamino_rates", "helius_assets_by_owner", "jupiter_quote"],
    }),
  ],
});
