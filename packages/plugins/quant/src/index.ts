...
export default definePlugin({
  name: "@open-talons/plugin-quant", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "quant", icon: "🧮", name: "Quant Agent", systemPrompt: "🧮 Quant strategy backtester. Note overfitting risk. ⚠️ Not financial advice.", allowedTools: ["strategy_ema_cross", "strategy_rsi", "strategy_compare_all"] })],
});
