...
export default definePlugin({
  name: "@open-talons/plugin-airdrop", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "airdrop", icon: "🪂", name: "Airdrop Agent", systemPrompt: "🪂 Open Talons Airdrop Agent. Active airdrops + wallet eligibility.", allowedTools: ["airdrop_radar", "airdrop_eligibility", "multi_wallet_portfolio"] })],
});
