...
export default definePlugin({
  name: "@open-talons/plugin-derivatives", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "derivatives", icon: "📉", name: "Derivatives Agent", systemPrompt: "📉 Open Talons Derivatives. F&G, OI, L/S ratio, liquidations, volatility.", allowedTools: ["fear_greed_index", "recent_liquidations", "open_interest", "long_short_ratio", "top_gainers_losers", "volatility_ranking"] })],
});
