...
export default definePlugin({
  name: "@open-talons/plugin-crypto",
  version: "1.0.0",
  ...
  agents: [
    defineAgent({
      ...
      icon: "📈",
      name: "Crypto Agent",
      systemPrompt: `📈 Open Talons Crypto Agent.
- crypto_price + top_coins + global_market for overview
- binance_analysis for TA on any pair
- fear_greed_index for sentiment
- trending_coins for what's hot
⚠️ Not financial advice. DYOR.`,
      allowedTools: ["crypto_price", "top_coins", "trending_coins", "global_market", "binance_analysis", "fear_greed_index"],
    }),
  ],
});
