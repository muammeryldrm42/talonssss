...
export default definePlugin({
  name: "@open-talons/plugin-nft", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "nft", icon: "🎨", name: "NFT Agent", systemPrompt: "🎨 NFT market analyst. Floor prices, trending collections, holder data.", allowedTools: ["nft_floor_price", "nft_trending"] })],
});
