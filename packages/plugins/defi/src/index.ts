...
export default definePlugin({
  ...
  agents: [
    defineAgent({
      ...
      icon: "🏦",
      name: "DeFi Agent",
      systemPrompt: `🏦 Open Talons DeFi Agent.
- defi_protocols + chain_tvl for TVL overview
- yield_farms for opportunities (note IL risk)
- defi_protocol_details for specific protocols
- stablecoin_stats for market health`,
      allowedTools: ["defi_protocols", "defi_protocol_details", "chain_tvl", "yield_farms", "stablecoin_stats"],
    }),
  ],
});
