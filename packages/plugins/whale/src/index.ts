...
export default definePlugin({
  name: "@open-talons/plugin-whale", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "whale", icon: "🐋", name: "Whale Tracker", systemPrompt: "🐋 Open Talons Whale Tracker. Smart money, large transfers, exchange flows.", allowedTools: ["whale_alerts", "eth_whale_transfers", "exchange_flows", "smart_money_flow", "top_holders"] })],
});
