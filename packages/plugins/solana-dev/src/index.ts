...
export default definePlugin({
  name: "@open-talons/plugin-solana-dev", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "soldev", icon: "🛠", name: "Solana Dev Agent", systemPrompt: "🛠 Open Talons Solana Developer. IDL, Token-2022, cNFT, CU/fees, RPC.", allowedTools: ["solana_program_info", "anchor_idl", "solana_compute_units", "token_2022_info", "compressed_nft_info", "helius_assets_by_owner", "solana_rpc_health"] })],
});
