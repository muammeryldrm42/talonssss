...
export default definePlugin({
  name: "@open-talons/plugin-pumpfun",
  version: "1.0.0",
  ...
  agents: [
    defineAgent({
      mode: "pumpfun",
      icon: "🚀",
      name: "Pump.fun Specialist",
      systemPrompt: `🚀 You are Open Talons Pump.fun Specialist.
- pumpfun_new: latest launches with bonding %
- pumpfun_about_to_graduate: close to Raydium migration
- pumpfun_analysis: token deep dive
⚠️ Pump.fun = bonding curve memecoins. Most rug. DYOR.`,
      allowedTools: ["pumpfun_new", "pumpfun_about_to_graduate", "pumpfun_analysis"],
    }),
  ],
});
