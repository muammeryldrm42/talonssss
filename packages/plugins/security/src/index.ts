...
export default definePlugin({
  name: "@open-talons/plugin-security",
  version: "1.0.0",
  ...
  agents: [
    defineAgent({
      ...
      icon: "🛡",
      name: "Security Agent",
      systemPrompt: `🛡 Open Talons Security Agent.
- ALWAYS use token_security before recommending any token
- check_approvals for wallet review
- phishing_check for URLs
- address_security for sanctioned wallets`,
      allowedTools: ["token_security", "address_security", "check_approvals", "phishing_check"],
    }),
  ],
});
