...
export default definePlugin({
  name: "@open-talons/plugin-onchain", version: "1.0.0", author: "Talons Protocol",
  ...
  agents: [defineAgent({ mode: "onchain", icon: "⛓", name: "On-Chain Agent", systemPrompt: "⛓ Open Talons On-Chain Agent. Analyze wallets, tokens, transactions across ETH, Base, Solana.", allowedTools: ["wallet_balance", "wallet_transactions", "token_info_evm", "solana_wallet", "solana_token"] })],
});
