// ============================================================
// 🦅 @open-talons/core — LLM Provider System
...
export const PROVIDER_INFO: Record<ProviderName, {
  ...
  openai: { name: "OpenAI", envKey: "OPENAI_API_KEY", signupUrl: "https://platform.openai.com", defaultModel: "gpt-4o", models: ["gpt-4o","gpt-4o-mini","o1-preview"], toolUseSupport: true, pricing: "Paid", notes: "Strong all-around" },
  gemini: { name: "Google Gemini", envKey: "GEMINI_API_KEY", signupUrl: "https://aistudio.google.com", defaultModel: "gemini-1.5-pro", models: ["gemini-2.0-flash-exp","gemini-1.5-pro","gemini-1.5-flash"], toolUseSupport: true, pricing: "Free tier", notes: "15 RPM free" },
  grok: { name: "xAI Grok", envKey: "XAI_API_KEY", signupUrl: "https://x.ai", defaultModel: "grok-2-latest", models: ["grok-2-latest","grok-beta"], toolUseSupport: true, pricing: "Paid", notes: "OpenAI-compat" },
  ...
  mistral: { name: "Mistral AI", envKey: "MISTRAL_API_KEY", signupUrl: "https://console.mistral.ai", defaultModel: "mistral-large-latest", models: ["mistral-large-latest","codestral-latest"], toolUseSupport: true, pricing: "Paid", notes: "European" },
  groq: { name: "Groq", envKey: "GROQ_API_KEY", signupUrl: "https://console.groq.com", defaultModel: "llama-3.3-70b-versatile", models: ["llama-3.3-70b-versatile","mixtral-8x7b-32768"], toolUseSupport: true, pricing: "Free tier", notes: "Blazing fast" },
  together: { name: "Together AI", envKey: "TOGETHER_API_KEY", signupUrl: "https://together.ai", defaultModel: "meta-llama/Llama-3.3-70B-Instruct-Turbo", models: ["meta-llama/Llama-3.3-70B-Instruct-Turbo"], toolUseSupport: true, pricing: "Paid", notes: "Open source models" },
  openrouter: { name: "OpenRouter", envKey: "OPENROUTER_API_KEY", signupUrl: "https://openrouter.ai", defaultModel: "anthropic/claude-3.5-sonnet", models: ["200+ models"], toolUseSupport: true, pricing: "Pay per use", notes: "ONE key = 200+ models" },
  ollama: { name: "Ollama (local)", envKey: "OLLAMA_HOST", signupUrl: "https://ollama.ai", defaultModel: "llama3.2", models: ["llama3.2","qwen2.5","deepseek-r1","mistral"], toolUseSupport: true, pricing: "FREE local", notes: "No API key" },
  lmstudio: { name: "LM Studio (local)", envKey: "LMSTUDIO_HOST", signupUrl: "https://lmstudio.ai", defaultModel: "local-model", models: ["whatever loaded"], toolUseSupport: true, pricing: "FREE local", notes: "OpenAI-compat local" },
  perplexity: { name: "Perplexity", envKey: "PERPLEXITY_API_KEY", signupUrl: "https://docs.perplexity.ai", defaultModel: "llama-3.1-sonar-large-128k-online", models: ["sonar-large","sonar-small"], toolUseSupport: false, pricing: "Paid", notes: "Built-in web search" },
};
  ...
  async call(req: LLMRequest): Promise<LLMResponse> {
    ...
    const messages: Anthropic.Messages.MessageParam[] = req.messages
      ...
      .map((m) => ({
        ...
        content: typeof m.content === "string" ? m.content : (m.content as Anthropic.Messages.ContentBlockParam[]),
      }));
    ...
    const res = await client.messages.create({
      ...
      system: req.system,
      messages,
      ...(req.tools ? { tools: req.tools as unknown as Anthropic.Messages.Tool[] } : {}),
    });
...
const OAI_CONFIGS: Record<Exclude<ProviderName, "anthropic"|"gemini"|"ollama">, { baseURL: string; envKey: string; defaultModel: string; extraHeaders?: Record<string, string> }> = {
  ...
  openrouter: { baseURL: "https://openrouter.ai/api/v1", envKey: "OPENROUTER_API_KEY", defaultModel: "anthropic/claude-3.5-sonnet", extraHeaders: { "HTTP-Referer": "https://github.com/muammeryldrm42/open-talons", "X-Title": "Open Talons" } },
...
export function detectDefaultProvider(): ProviderName {
  const priority: ProviderName[] = ["anthropic","openai","gemini","groq","deepseek","openrouter","ollama"];
