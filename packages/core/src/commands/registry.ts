// ============================================================
// 🦅 @open-talons/core — Slash Command Registry
// ============================================================
...
export class CommandRegistry {
   ...
   */
  async tryExecute(input: string, talons: unknown, output: (msg: string) => void): Promise<boolean> {
    ...
    const ctx: SlashCommandContext = { args, raw: input, talons, output };
    try {
